...
struct Additive {
    var id: String = ""
    var name: String = ""
    var source: Source = .vegetable
    var category: Category = .antioxidants
    var danger: Danger = .null
    var note: String = ""
    
//    init(id: String = "", name: String = "", source: Source, category: Category, danger: Danger, note: String = "") {
//
//        self.id = id
//        self.name = name
//        self.source = source
